...
export const FALLBACK_SYSTEM_SETTINGS: AdminSystemSettings = {
  id: "global_config",
  general: {
    siteName: "AIJobs Enterprise Platform",
    supportEmail: "enterprise-support@aijobs.global",
...
export const FALLBACK_AUDIT_LOGS: SystemAuditLog[] = [
  {
    id: "log_001",
    userId: "admin_uid",
    userName: "Super Admin",
    userEmail: "admin@aijobs.demo",
    role: "Super Admin",
    action: "LOGIN",
    category: "User",
    description: "Super Admin completed multi-factor authentication from secure terminal gateway.",
...
export const FALLBACK_CMS: CMSContent[] = [
  {
    id: "cms_faq_1",
    type: "faq",
    title: "How does the AI Resume Analyzer rank matching candidates?",
...
export const FALLBACK_NOTIFICATIONS: SystemNotification[] = [
  {
    id: "notif_broadcast_1",
    title: "Upcoming AI Engine Core Upgrades",
    message: "Our generative models will undergo API gateway maintenance on Sunday 02:00 AM IST.",
    targetRole: "all",
    type: "maintenance",
    sentBy: "Super Admin",
...
export const FALLBACK_EMAILS: EmailTemplate[] = [
  {
    id: "tpl_welcome",
    name: "Candidate Welcome Greeting",
    subject: "Welcome to AIJobs, {{candidate_name}}! 🚀",
...
export const FALLBACK_PAYMENTS: PaymentTransaction[] = [
  {
    id: "txn_2026_0911",
    userId: "cons_quantum_talent",
    userName: "Quantum Sourcing Labs",
...
export const FALLBACK_USERS: any[] = [
  ...
  {
    uid: "fallback_cons_1",
    name: "Nexus Talent Partners",
    email: "nexus@talentpartners.com",
    role: "consultancy",
    createdAt: new Date().toISOString()
  },
  {
...
export const FALLBACK_JOBS: any[] = [
  {
    ...
    description: "Join us to build state-of-the-art interactive portals.",
