    ...
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 text-slate-300 text-xs leading-relaxed space-y-1">
        <div className="font-semibold text-sky-400 text-sm flex items-center gap-2">
          ...
          <span className="font-mono bg-slate-800 px-2 py-0.5 rounded text-white">{SITE_URL}</span>
        </div>
        <p>
          All published job postings automatically generate a public SEO canonical URL (<code className="text-sky-300">{SITE_URL}/jobs/&#123;slug&#125;</code>) with Schema.org JobPosting JSON-LD.
